...
for(var i = 0; i < table_ids.length; i++){
	...
	//document.getElementById(table_ids[i]).innerHTML = "A";
}
...
if(game_started){
	...
	if(!table_ids.includes(move_id)){
	alert("Invalid move");
	return;
	}
	if(document.getElementById("turn_info").innerHTML == "Turn for: <b>X</b>"){
		document.getElementById("turn_info").innerHTML = "Turn for: <b>O</b>";
	}
	else if(document.getElementById("turn_info").innerHTML == "Turn for: <b>O</b>"){
		document.getElementById("turn_info").innerHTML = "Turn for: <b>X</b>";
	}
	else{
	alert("turn info error");
	return;
	}
	
	if(document.getElementById(move_id).innerHTML == move_id){
		if(document.getElementById("turn_info").innerHTML == "Turn for: <b>O</b>"){
		document.getElementById(move_id).innerHTML = "X";
		}
		else if(document.getElementById("turn_info").innerHTML == "Turn for: <b>X</b>"){
		document.getElementById(move_id).innerHTML = "O";
		}
		else{
		alert("turn info error 2");
		return;
		}
	} 
	else{
	...
	//evaluate the state of the table
