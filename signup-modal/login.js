...
function enableButton(letter, capital, number, length, match) {
   ...
   // console.log(match.classList.contains("valid"));
    var condition = (match.classList.contains("valid") && letter.classList.contains("valid") && 
			capital.classList.contains("valid") && number.classList.contains("valid") &&
			length.classList.contains("valid")); // TODO: Replace false with the correct condition
